...
namespace CNP.Language
{
  ...
  public class NameVarBindings
  {
    ...
    public (NameVar, NameVar) AddNameVars(string name1, string name2)
    {
      return (AddNameVar(name1), AddNameVar(name2));
    }

    public (NameVar, NameVar, NameVar) AddNameVars (string name1, string name2, string name3)
    {
      return (AddNameVar(name1), AddNameVar(name2), AddNameVar(name3));
    }
